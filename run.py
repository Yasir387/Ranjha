...
def methode():
  ...
  if sek=="":print("\033[0;97m   [!] Isi Ranjha Yasir").format(R,N);methode()
  elif sek=="1":
    crack()
  elif sek=="2":
    crack1()
    ...
    print("\033[0;97m   [!] Isi Ranjha Yasir").format(R,N);methode()
def logs():
  banner()
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  ...
  if sek=="":
    print("\033[0;97m   [!] Isi Ranjha Yasir").format(R,N);logs()
  elif sek=="1":
    log_token()
  elif sek=="2":
    gen()
